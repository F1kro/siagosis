...
<head>
    ...
    <title>@yield('title') - SIAGOSIS Student</title>
        ...
        <div class="row">
            ...
            <div class="col-md-2 px-0 sidebar">
                <div class="d-flex flex-column p-3">
                    <a href="{{ route('student.dashboard') }}" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                    ...
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('student.behavior-notes') }}" class="nav-link {{ request()->routeIs('student.behavior-notes') ? 'active' : '' }}">
                                <i class="fas fa-comments"></i> Behavior Notes
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('student.news') }}" class="nav-link {{ request()->routeIs('student.news') ? 'active' : '' }}">
                    ...
                    <div class="dropdown">
                        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}&background=random" alt="Student" width="32" height="32" class="rounded-circle me-2">
            ...
            <div class="col-md-10 ms-sm-auto px-4 content">
                <nav class="navbar navbar-expand-lg navbar-light bg-light rounded mb-4">
                    <div class="container-fluid">
                        <span class="navbar-brand">@yield('title', 'Student Dashboard')</span>
