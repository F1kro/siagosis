      ...
      <div className="container flex h-14 items-center">
        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent side="left" className="pr-0">
            <Link href="/teacher/dashboard" className="flex items-center" onClick={() => setIsOpen(false)}>
              <span className="font-bold text-xl">SIAGOSIS</span>
            </Link>
            <div className="my-4">
        ...
        <div className="flex flex-1 items-center justify-between space-x-2 md:justify-end">
          <div className="w-full flex-1 md:w-auto md:flex-none">
            <Link href="/teacher/dashboard" className="mr-6 flex items-center space-x-2 md:hidden">
